...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="/">
        <xsl:for-each select="measures-reorganizing-working-time/measure-reorganizing-working-time">
...
INSERT INTO measures_reorganizing_working_time (Code, DescriptionNL, DescriptionFR
        , DMFA, DMFAAPL, Capelo_DHG
...
VALUES("<xsl:value-of select="code"/>"
        ...
        , "<xsl:value-of select="DMFAAPL"/>"
        , "<xsl:value-of select="Capelo_DHG"/>"
