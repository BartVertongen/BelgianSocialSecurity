...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="/">
        <xsl:for-each select="employer-categories/employer-category">
...
INSERT INTO employer_category_Renumerations (Number, Code, DescriptionNL, DescriptionFR
    , RemarkNL, RemarkFR, BeginValidity, EndValidity)
VALUES("<xsl:value-of select="number"/>"
