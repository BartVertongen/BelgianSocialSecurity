...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="/">
        <xsl:for-each select="employee-codes/employee-code">
...
INSERT INTO declarant-roles(Code, TypeNL, TypeFR, DescriptionNL, DescriptionFR
    , EmployeeTypeNL, EmployeeTypeFR, Presence, BeginValidity, EndValidity)
VALUES("<xsl:value-of select="code"/>"
        ...
        , "<xsl:value-of select="employee-type/nl"/>"
        , "<xsl:value-of select="employee-type/nl"/>"
