...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="/">
        <xsl:for-each select="risk-identifications/risk-identification">
...
INSERT INTO risk_identifications (IdMain, IdSub, TitleNL, TitleFR
    , DescriptionNL, DescriptionFR, ScenarioNl, ScenarioFr
    , BeginValidity, EndValidity)
VALUES("<xsl:value-of select="id/main"/>"
        , "<xsl:value-of select="id/sub"/>"
        ...
        , "<xsl:value-of select="scenario/nl"/>"
        , "<xsl:value-of select="scenario/fr"/>"
