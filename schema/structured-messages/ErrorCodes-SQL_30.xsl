...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="/">
        <xsl:for-each select="error-codes/error-code">
...
INSERT INTO error-codes (code, descriptionNL, descriptionFR, beginValidity, endValidity)
VALUES("<xsl:value-of select="code"/>", "<xsl:value-of select="description/nl"/>"
        , "<xsl:value-of select="description/fr"/>", "<xsl:value-of select="$beginValidity"/>"
