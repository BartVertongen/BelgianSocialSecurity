...
SELECT "00910"
        ...
        , "Alfanumeriek"
        , "10"
        , "Onmisbaar in het blok 90530 InterruptionInformation. Verplicht in het blok 90535 CollectiveLabourAgreement indien het registratienummer van de CAO niet bestaat (ondernemings-cao)."
        , "JJJJ-MM-DD -- JJJJ is het jaar -- MM is de maand -- DD is de dag"
WHERE NOT EXISTS (SELECT * FROM zones
                    WHERE Code = '00910'
                          AND Version = '2023/1'
...
SELECT "01225"
        ...
        , "Numeriek"
        , "3"
        , "Verplicht indien het een gedeeltelijke onderbreking betreft. Verboden indien het een voltijds onderbreking betreft."
        , ""
WHERE NOT EXISTS (SELECT * FROM zones
                    WHERE Code = '01225'
                          AND Version = '2023/1'
...
SELECT "00636"
        ...
        , "Alfanumeriek"
        , "20"
        , "Facultatief. Een telefoonnummer of een Gsm-nummer is verplicht."
        , ""
WHERE NOT EXISTS (SELECT * FROM zones
                    WHERE Code = '00636'
                          AND Version = '2023/1'
...
SELECT "00740"
        ...
        , "CLARegistrationNbr"
        , "Collectieve arbeidsovereenkomst"
        , "Nummer waaronder de CAO geregistreerd staat bij de griffie van de dienst Collectieve Arbeidsbetrekkingen van de FOD Werkgelegenheid, Arbeid en Sociaal Overleg\nAan de hand van het registratienummer kunnen op meta.fgov.be de sectoriële CAO's worden geconsulteerd. In dit geval moet de werknemer geen kopie meer indienen van de CAO. Registratienummer van de sectoriï¿½le CAO die het mogelijk maakt\n- in functie van de bepalingen van CAO 103 het recht op halftijds of voltijds tijdskrediet met motief uit te breiden\n- in functie van de bepalingen van CAO nr. 118 of CAO nr. 127 het recht op het tijdskrediet met uitkeringen vóór de wettelijke leeftijd te openen."
        , "Geheel getal van 5 of 6 posities."
        , ""
        , "Numeriek"
        , "6"
        , "Verplicht indien het een sectoriële CAO betreft."
        , ""
WHERE NOT EXISTS (SELECT * FROM zones
                    WHERE Code = '00740'
                          AND Version = '2023/1'
...
SELECT "01226"
        ...
        , "TimeUnit"
        , "Informatie over de loopbaanonderbreking of het tijdskrediet"
        , "Code die een tijdseenheid aanduidt. Tijdseenheid van de cyclus tijdens dewelke de arbeidsregeling vast is of tijdseenheid van de referteperiode waarin de arbeidsregeling variabel is."
...
SELECT "01224"
        ...
        , "F = Vaste arbeidsregeling; V = Variabel arbeidsregeling"
        , ""
        , "Alfanumeriek"
        , "1"
        , "Verplicht indien het een gedeeltelijke onderbreking betreft. Verboden indien het een voltijds onderbreking betreft."
