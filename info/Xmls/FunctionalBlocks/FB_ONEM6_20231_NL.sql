...
SELECT "90044"
        ...
        , "AnnualDclTempUnemployment"
        , "Functioneel blok dat toelaat de specifieke gegevens van de aangifte vaststellen recht tijdelijke werkloosheid aan te geven."
        , "1"
        , "1"
        , "ONMISBAAR"
        , ""
...
SELECT "90404"
        ...
        , "0"
        , "1"
        , "VERPLICHT INDIEN de begindatum tijdelijke werkloosheid na 2015 ligt en het betreft een deeltijdse tewerkstelling die in de refertemaand tijdelijk minstens voltijds is.
...
SELECT "90168"
        ...
        , "De aangifte van schorsing bedienden wegens werkgebrek (identificatie van het risico '011') of van tijdelijke werkloosheid ingevolge collectieve sluiting van de onderneming wegens vakantie krachtens een algemeen bindend verklaarde CAO (identificatie van het risico '007'), is niet toegelaten voor een provinciaal en/of plaatselijk bestuur."
WHERE NOT EXISTS (SELECT * FROM functional_blocks
                    WHERE Code = '90168'
                          AND Version = '2023/1'
);
...
SELECT "90082"
        ...
        , "0"
        , "3"
        , "Kardinaliteit 0 ... 2 indien 00110 Status van het attest = '0' (Origineel)\nKardinaliteit 1 ... 3 indien 00110 Status van het attest = '1' (Wijziging) of '3' (Annulatie). In dit geval is alleen één blok referentie nodig met als waarde '3' voor de zone 00221 - TYPE VAN DE REFERENTIE en met als waarde '2' voor de zone 00298 - HERKOMST VAN DE REFERENTIE."
...
SELECT "90060"
        ...
        , "0"
        , "1"
        , "VERPLICHT INDIEN de begindatum tijdelijke werkloosheid vóór 2016 ligt. VERBODEN in alle andere gevallen."
        , ""
WHERE NOT EXISTS (SELECT * FROM functional_blocks
                    WHERE Code = '90060'
                          AND Version = '2023/1'
