...
SELECT "90045"
        ...
        , "DeclarationPartTimeWorkWithMaintenanceRights"
        , "Functioneel blok dat toelaat de specifieke gegevens van de aangifte van aanvang deeltijdse arbeid aan te geven."
        , "1"
        , "1"
        , "ONMISBAAR"
        , ""
...
SELECT "90060"
        ...
        , "0"
        , "1"
        , "VERPLICHT INDIEN de begindatum van de deeltijdse tewerkstelling vóór 2016 ligt. VERBODEN in alle andere gevallen."
        , ""
WHERE NOT EXISTS (SELECT * FROM functional_blocks
                    WHERE Code = '90060'
                          AND Version = '2023/1'
