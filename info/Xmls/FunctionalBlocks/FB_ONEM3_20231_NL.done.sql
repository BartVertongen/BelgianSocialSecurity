...
SELECT "90037"
        ...
        , "0"
        , "1"
        , "Kardinaliteit 1: VERPLICHT indien de prestaties niet duidelijk kunnen verdeeld worden in uren."
        , ""
WHERE NOT EXISTS (SELECT * FROM functional_blocks
                    WHERE Code = '90037'
                          AND Version = '2023/1'
...
SELECT "90048"
        ...
        , "MonthlyWorkDeclarationOfEmployeeWorkingInShelteredIndustry"
        , "Functioneel blok dat toelaat de specifieke gegevens van de maandelijkse aangifte van arbeid als werknemer tewerkgesteld in een beschermde werkplaats aan te geven."
        , "1"
        , "1"
        , "ONMISBAAR"
        , ""
...
SELECT "90060"
        ...
        , "0"
        , "1"
        , "VERPLICHT INDIEN de maand met eerste jeugd- of seniorvakantiedag vóór 2016 ligt. VERBODEN in alle andere gevallen."
        , ""
WHERE NOT EXISTS (SELECT * FROM functional_blocks
                    WHERE Code = '90060'
                          AND Version = '2023/1'
